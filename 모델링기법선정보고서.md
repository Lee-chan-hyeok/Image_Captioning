...
- 사용 데이터 설명
  - 데이터 출처 - Kaggle
    ![image1](selected_result\report1_image\image1.png)
...
- 데이터 전처리 과정 및 방법
  ...
  - Normalization: 데이터를 정규화하여 모델 입력에 적합하게 변환
    ...
    ![image2](selected_result\report1_image\image2.png)
...
- 고려된 모델링 기법
  ...
  - 모델의 예상 아키텍처
    ...
    - `Decoder`
      ...
      ![image3](selected_result\report1_image\image3.png)
...
- 성능 지표
    ...
    > - 예측한 문장의 길이가 짧을 경우 큰 패널티가 부여됨.
      ![image4](selected_result\report1_image\image4.png)<br/>
